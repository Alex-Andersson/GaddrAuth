...
import GitHubLogo from "../assets/github-icon.jpg";
...
import { getTikTokUrl } from "../utils/getTikTokUrl";
import { getTwitterkUrl } from "../utils/getTwitterUrl";
import { getFacebookkUrl } from "../utils/getFacebookUrl";
...
const LoginPage = () => {
  ...
  function getFacebookUrl(from: string): string | undefined {
